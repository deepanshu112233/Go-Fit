...
<body>
  ...
  <div class="bdy">
    ...
    <button class="emoji-box" id="sad" onclick="location.href='result.php';"><div class="emoji">😢</div> <span class="txt">Sad</span></button>
      <button class="emoji-box" id="angry" onclick="location.href='result.php';"><div class="emoji">😡</div> <span class="txt">Angry</span></button>
      ...
      <button class="emoji-box" id="sleepy" onclick="location.href='result.php';"><div class="emoji">🤒</div> <span class="txt">Sick</span></button>
      <button class="emoji-box" id="sleepy" onclick="location.href='result.php';"><div class="emoji">😞</div> <span class="txt">Disappointed</span></button>
      <button class="emoji-box" id="sleepy" onclick="location.href='result.php';"><div class="emoji">😌</div> <span class="txt">Relieved</span></button>
      <button class="emoji-box" id="sleepy" onclick="location.href='result.php';"><div class="emoji">🫥</div> <span class="txt">Surprised</span></button>
      <button class="emoji-box" id="sleepy" onclick="location.href='result.php';"><div class="emoji">😬</div> <span class="txt">Nervous</span></button>
